...
$customer->setPhone(Util::sanitize_xss($_POST["phone"]));

$customer->setAddress(Util::sanitize_xss($_POST["address"]));

$customer->setCitycode(Util::sanitize_xss($_POST["citycode"]));

$customer->setBday(Util::sanitize_xss($_POST["bday"]));
